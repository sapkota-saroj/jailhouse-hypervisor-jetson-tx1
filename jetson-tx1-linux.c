/* write mem=3000M in extconfig in order reserve memory for hypervisor*/ 
...
struct {
        ...
        .mem_regions = {
                /* UART */ {
                  ...
                  /* RAM */ {
                        .phys_start = 0x161100000,//0x15B800000,//0x17bef0000,
                ...
                /* RAM */ {
                        .phys_start =0x161200000,// 0x13B800000,//0x161200000,
                        .virt_start =0x80000000,//0xe8000000,//161200000,
                        .size=0x1ae00000,
                        .flags = JAILHOUSE_MEM_READ | JAILHOUSE_MEM_WRITE |
                                JAILHOUSE_MEM_EXECUTE | JAILHOUSE_MEM_DMA |
                                JAILHOUSE_MEM_LOADABLE,
                ...
                /* IVSHMEM shared memory region */ {
                        .phys_start = 0x17ba00000,//0x17bf00000
